...
# Generated on: Sat Apr 22 22:50:00 EDT 2023 (Sun Apr 23 02:50:00 GMT 2023)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file logs_Apr22-22:49:46/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information fv_map_controller_mv_db

read_implementation_information fv/controller -golden fv_map -revised controller_mv
...
read_library -liberty -both   /escnfs/courses/fa22-cse-40462.01/dropbox/dgarci23/mips8/muddlib.lib

read_design -verilog95   -golden -lastmod -noelab fv/controller/fv_map.v.gz
elaborate_design -golden -root {controller}

read_design -verilog95   -revised -lastmod -noelab outputs_Apr22-22:49:46/controller_m.v
elaborate_design -revised -root {controller}

#add_name_alias fv/controller/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/controller/controller_mv.singlebit.original_name.alias.json.gz -revised
